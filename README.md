...
| AI Content Studio | Generates editable captions, promotional posts, WhatsApp messages, ad copy, short-form ideas, headlines, and calls to action. |
...
| `generatedContents` | Editable saved marketing content, channel, type, tone, and optional campaign relationship. |
